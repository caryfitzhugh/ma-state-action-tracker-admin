...
class LeadAgencyQuickCreateButton extends Component {
  state = {
    error: false,
    showDialog: false,
  };
  ...
  handleSaveClick = () => {
    ...
    submit("lead-agency-quick-create");
  };
  ...
  handleSubmit = values => {
    ...
    let res = dataProvider(CREATE, "lead-agencies", { data: values });
    res.then(({ data }) => {
        // Update the main react-admin form (in this case, the comments creation form)
        change(REDUX_FORM_NAME, "lead_agency_id", data.id)
        this.setState({ showDialog: false });
      })
      .catch(error => {
        ...
        >
          ...
          <DialogContent>
            <SimpleForm
              ...
              form="lead-agency-quick-create"
              resource="lead-agencies"
...
const mapStateToProps = state => ({
  isSubmitting: isSubmitting("lead-agency-quick-create")(state),
});
